...
def _get_plt() -> Any:
    """Import matplotlib lazily so it stays an optional (``sonde[viz]``) dependency."""
    try:
        ...
        raise ModuleNotFoundError(
            "ProbeAnalyzer plotting requires matplotlib. Install it with "
            "`pip install 'sonde[viz]'` (or add matplotlib to your environment)."
        ) from exc
    return plt
